...
execute as @e[type=brst:fac_crystal] if score @s death_timer >= @s arg1 as @s[scores={arg2=5}] at @s as @e[r=5,type=xp_orb] at @s run structure load xp_crystal ~~~ 0_degrees none
...
execute as @e[type=brst:fac_crystal] if score @s death_timer >= @s arg1 as @s[scores={arg2=10}] at @s as @e[r=10,type=xp_orb] at @s run structure load xp_crystal ~~~ 0_degrees none
...
execute as @e[type=brst:fac_crystal] if score @s death_timer >= @s arg1 as @s[scores={arg2=15}] at @s as @e[r=15,type=xp_orb] at @s run structure load xp_crystal ~~~ 0_degrees none
...
execute as @e[type=brst:fac_crystal] if score @s death_timer >= @s arg1 as @s[scores={arg2=20}] at @s as @e[r=20,type=xp_orb] at @s run structure load xp_crystal ~~~ 0_degrees none
...
execute as @e[type=brst:fac_crystal] if score @s death_timer >= @s arg1 as @s[scores={arg2=25}] at @s as @e[r=25,type=xp_orb] at @s run structure load xp_crystal ~~~ 0_degrees none
...
execute as @e[type=brst:fac_crystal] if score @s death_timer >= @s arg1 as @s[scores={arg2=30}] at @s as @e[r=30,type=xp_orb] at @s run structure load xp_crystal ~~~ 0_degrees none
