...
execute as @s[type=brst:small_rock] as @s[scores={death_timer=1}] at @s align xyz positioned ~0.5 0 ~0.5 run damage @e[type=player,r=1] 16 entity_attack entity @s
...
execute as @s[type=brst:small_rock] as @s[scores={death_timer=3}] at @s align xyz positioned ~0.5 0 ~0.5 run damage @e[type=player,r=1.5] 14 entity_attack entity @s
...
execute as @s[type=brst:small_rock] as @s[scores={death_timer=5}] at @s align xyz positioned ~0.5 0 ~0.5 run damage @e[type=player,r=2] 12 entity_attack entity @s
...
execute as @s[type=brst:small_rock] as @s[scores={death_timer=7}] at @s align xyz positioned ~0.5 0 ~0.5 run damage @e[type=player,r=2] 10 entity_attack entity @s
