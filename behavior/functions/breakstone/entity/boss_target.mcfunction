...
#darkray
execute as @s[type=brst:boss_target,name=darkray] as @s[scores={death_timer=1}] at @s run spreadplayers ~~ 1 15 @s
execute as @s[type=brst:boss_target,name=darkray] as @s[scores={death_timer=1}] at @s run tp @s ~ -30 ~
execute as @s[type=brst:boss_target,name=darkray] as @s[scores={death_timer=1}] at @s run scoreboard players random @s func_move_y -10 10
